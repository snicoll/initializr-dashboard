...
public class StatsContainer {
	...
	static class Builder {
		...
		Builder addSeries(MultiValueMap<String, GenerationStatistics.Record> series) {
		...
		Builder addTopClients(List<ReverseLookupDescriptor> resolvedIps) {
